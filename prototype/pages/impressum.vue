<template>
	<div class="p-5">
		...
		<span class="font-bold">Medieninhaber/Herausgeber</span>: Swiss Booking AG
		...
		Leistungen im Bereich eCommerce <br />
		<h2 class="text-xl font-bold">1. Inhalt des Onlineangebotes</h2>
		...
		einzustellen.
		<h2 class="text-xl font-bold">2. Verweise und Links</h2>
		...
		<h2 class="text-xl font-bold">4. Urheber- und Kennzeichenrecht</h2>
		...
		<h2 class="text-xl font-bold">5. Datenschutz</h2>
		...
		besteht, so erfolgt die Preisgabe dieser Daten seitens des Nutzers
		ausdrücklich auf freiwilliger Basis. Die Nutzung der im Rahmen des
		Impressums oder vergleichbarer Angaben veröffentlichten Kontaktdaten wie
		Postanschriften, Telefon- und Faxnummern sowie E-Mail-Adressen durch Dritte
...
pageStore.addPageToPath("Impressum", "/impressum");
</script>
